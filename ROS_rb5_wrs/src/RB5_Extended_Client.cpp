...
void State::objectFound()
{
    ...
    //pick up object
    command(CMD_MoveTCP,0,0,-15.78, -685.14,470.7,-170.82,83.41,-179.82,0.8,0.3);
    ROS_INFO("Starting transport.");
    ac_.sendGoalAndWait(rb5_goal, ros::Duration(10.0));

    //move towards the destination
    command(CMD_MoveTCP,0,0, xDest, yDest, zDest, 180, -90, -90,0.8,0.3);
...
void State::goHome()
{
    command(CMD_MoveJoint,0,0,-31.07, -20.94, 122.16, 78.74, -30.99, -90.99,0.8,0.3);
    ROS_INFO("Going home.");
    ac_.sendGoalAndWait(rb5_goal, ros::Duration(10.0));
