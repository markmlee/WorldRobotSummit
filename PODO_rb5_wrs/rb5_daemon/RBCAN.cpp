    ...
    while(rbCAN->isWorking){
        ...
        if(rbCAN->canSendSuspend == true){
            if(rbCAN->canHeadIndex != rbCAN->canTailIndex){
                ...
                //printf("Write Ch = %d, Id = %d\n",rbCAN->canWriteMB[index].channel, rbCAN->canWriteMB[index].id);
                //printf("data = %d, %d\n",rbCAN->canWriteMB[index].data[0],rbCAN->canWriteMB[index].data[1]);
...
void RBCAN::RBResetCAN(){
    ...
    for(int i=0; i<MAX_SEARCH_CHANNEL; i++){
        char filePath[30];
        sprintf(filePath, "/dev/pc--**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************anusb%d", i);
        canHandler[oknum] = NULL;
        canHandler[oknum] = LINUX_CAN_Open(filePath, O_RDWR);
...
{
    int threadID = pthread_create(&canReadThreadHandler, NULL, &RBCAN_ReadThread, this);
    if(threadID < 0){
        FILE_LOG(logERROR) << "RBCAN: Read thread Creation Error";
        return false;
    }
    threadID = pthread_create(&canWriteThreadHandler, NULL, &RBCAN_WriteThread, this);
    if(threadID < 0){
...
int RBCAN::RBCAN_GetCount()
{
    return canMBCounter;
}

int RBCAN::RBCAN_GetId(int _id)
{
    return canReadMB[_id].id;
}
