...
enum{
    ...
    ROBOTWORLD_ROS_GO2DISPLAY_MANUAL,
    ROBOTWORLD_ROS_GO2HOME_MANUAL
};
...
{
    int             ROS_COMMAND = ROBOTWORLD_ROS_NO_ACT;
    int             SELECTED_MENU = NO_SIGNAL;
    ObjectPos       Objpos[20];
    ObjectPos       robot_pos;
    MANUAL_MOVE     ROS_MOVE;
...
{
    int             MOTION_ERROR = NO_ERROR;
    int             MOTION_STATE = AL_NO_ACT;
